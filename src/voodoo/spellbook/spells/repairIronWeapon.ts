...
export const repairIronWeapon = async (voodoo: VoodooServer, accountId: number): Promise<void> => {
  ...
  const repairedApparatus = repairMaterial(hiltedApparatus, MaterialHash.Iron, 0.25);
