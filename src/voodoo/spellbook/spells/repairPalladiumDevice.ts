...
export const repairPalladiumDevice = async (voodoo: VoodooServer, accountId: number): Promise<void> => {
  ...
  const repairedApparatus = repairMaterial(hiltedApparatus, MaterialHash.CarsiAlloy, 0.25);
