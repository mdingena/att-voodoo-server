...
export const repairSilverDevice = async (voodoo: VoodooServer, accountId: number): Promise<void> => {
  ...
  const repairedApparatus = repairMaterial(hiltedApparatus, MaterialHash.Silver, 0.25);
