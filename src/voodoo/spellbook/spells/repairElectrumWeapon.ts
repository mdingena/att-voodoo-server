...
export const repairElectrumWeapon = async (voodoo: VoodooServer, accountId: number): Promise<void> => {
  ...
  const repairedApparatus = repairMaterial(hiltedApparatus, MaterialHash.WhiteGoldAlloy, 0.25);
